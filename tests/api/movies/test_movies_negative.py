class TestMoviesNegative:
    ...
    def test_create_movie_with_bad_params(self, movie_data, api_manager, super_admin):
    ...
    def test_create_existing_movie(self, created_movie, api_manager, movie_data):
    ...
    def test_get_non_existent_movie(self, api_manager, created_movie):
        response = created_movie.json()
    ...
    def test_delete_non_existent_movie(self, api_manager, created_movie):
        response = created_movie.json()
        api_manager.movies_api.delete_movie_by_id(movie_id = response["id"])
        response_delete_non_existent_movie = api_manager.movies_api.delete_movie_by_id(movie_id = response["id"], expected_status = 404)

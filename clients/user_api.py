...
class UserApi(CustomRequester):
    ...
    def get_user_info(
        ...
        with allure.step("Формирование запроса на получение данных пользователя"):
    ...
    def delete_user(self, user_id: str | None, expected_status: int = 200) -> Response:
        with allure.step("Формирование запроса на удаление пользователя"):
            return self.send_request(
                method="DELETE",
                endpoint=f"{Endpoints.USER.value}/{user_id}",
                expected_status=expected_status,
    ...
    def patch_user_data(
        ...
        with allure.step("Формирование запроса на изменение данных пользователя"):
            return self.send_request(
                method="PATCH",
                endpoint=f"{Endpoints.USER.value}/{user_id}",
                expected_status=expected_status,
    ...
    def create_user(
        ...
        with allure.step("Формирование запроса на создание пользователя"):
            return self.send_request(
                method="POST",
    ...
    def get_list_users(self, expected_status: int | None = None, **kwargs) -> Response:
        with allure.step("Формирование запроса на получения списка пользователей"):
            return self.send_request(
                method="GET",
                endpoint=f"{Endpoints.USER.value}",
                expected_status=expected_status,
